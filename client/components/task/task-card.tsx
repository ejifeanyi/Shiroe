    ...
    switch (priority) {
      case "urgent":
        return {
          ...
          badgeColor: "bg-red-100 text-red-800 dark:bg-red-950/50 dark:text-red-300 hover:bg-red-100 dark:hover:bg-red-950/50",
          icon: "text-red-500 dark:text-red-400",
        };
      case "high":
        return {
          borderColor: "border-orange-400 dark:border-orange-600",
          badgeColor: "bg-orange-100 text-orange-800 dark:bg-orange-950/50 dark:text-orange-300 hover:bg-orange-100 dark:hover:bg-orange-950/50",
          icon: "text-orange-400 dark:text-orange-300",
        };
      case "medium":
        return {
          borderColor: "border-blue-400 dark:border-blue-600",
          badgeColor: "bg-blue-100 text-blue-800 dark:bg-blue-950/50 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-950/50",
          icon: "text-blue-400 dark:text-blue-300",
        };
      case "low":
        return {
          borderColor: "border-green-400 dark:border-green-600",
          badgeColor: "bg-green-100 text-green-800 dark:bg-green-950/50 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-950/50",
          icon: "text-green-400 dark:text-green-300",
        };
      default:
        return {
          borderColor: "border-slate-200 dark:border-slate-700",
          badgeColor: "bg-slate-100 text-slate-800 dark:bg-slate-800 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800",
  ...
  return (
    <div
      className={cn(
        ...
        isDragging ? "shadow-md opacity-70 rotate-1 scale-105" : "hover:shadow-md"
      )}
    >
